...
//       const itemsToSend = Array.isArray(cart) ? cart : cart.items;
...
//       const orderRes = await api.post("/order-pay/create-vnpay-order", {
//         items: formattedItems,
//         address: form.address,
//         phone: form.phone,
//         amount: total,
//         userId: user.id, // không gửi cái này là lỗi 400
//       });
...
//     } catch (err) {
//       console.error(err);
//       alert("Không thể tạo đơn hàng VNPay");
//     }
//   };
...
//                           </p>
//                           <p className="text-sm text-gray-500">
//                             Thanh toán qua thẻ ATM, Visa, MasterCard, Momo
//                           </p>
//                         </div>
//                       </div>
//                     </label>
...
//                       <img
//                         src={
//                           item.imageSnapshot || "https://via.placeholder.com/60"
//                         }
...
export default function CheckoutPage() {
  ...
  const validatePhone = (phone) => {
    ...
    return /^(0|\+84|84)[0-9]{9,10}$/.test(clean);
  };
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <h2 className="text-2xl font-bold flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full flex items-center justify-center">
                  1
                </div>
                Thông tin giao hàng
              </h2>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 rounded-xl focus:border-pink-500"
                    value={form.address}
                    onChange={(e) =>
                      setForm({ ...form, address: e.target.value })
                    }
            ...
            <div className="sticky top-20 bg-white rounded-2xl shadow-xl p-6">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between font-semibold text-lg">
                  <span>Tổng cộng</span>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600 text-2xl font-bold">
                    {total.toLocaleString("vi-VN")}₫
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full mt-6 py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition"
              >
                Hoàn tất đặt hàng
              </button>
            </div>
