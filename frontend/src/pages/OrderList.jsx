      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-500 mb-8">
            Bắt đầu mua sắm hôm nay và trải nghiệm dịch vụ của chúng tôi!
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-10">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-600 mb-10">
          Bạn có{" "}
          <span className="font-semibold text-pink-600">{orders.length}</span>{" "}
          đơn hàng
        </p>
                        ...
                        return (
                          ...
                          >
                            <img
                              ...
                              alt={item?.nameSnapshot || "Sản phẩm"}
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-pink-600 font-semibold text-lg mt-1">
                                Tổng: {lineTotal.toLocaleString("vi-VN")}₫
                              </p>
                            </div>
                          </div>
                        );
